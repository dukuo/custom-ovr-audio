...
`
      ...
      expect(state[0].diffuse).toEqual([
        0.03333333333333333, 0.47333333333333333, 1.0
      ]);
      ...
      expect(state[1].diffuse).toEqual([
        0.14666666666666667, 0.8466666666666667, 0.0
      ]);
      ...
      expect(state[2].diffuse).toEqual([
        0.82, 0.0, 1.0
      ]);
      ...
      expect(state[3].diffuse).toEqual([
        1.0, 0.08666666666666667, 0.08666666666666667
      ]);
      ...
      expect(state[4].diffuse).toEqual([
        1.0, 1.0, 0.0
      ]);
