...
var computeLayout = (function() {
  ...
  function layoutNodeImpl(node, parentMaxWidth, parentMaxHeight, /*css_direction_t*/parentDirection) {
    ...
    while (endLine < childCount) {
      ...
      // container!
      // MikeA: patching to follow logic at
      // https://github.com/facebook/yoga/blob/master/yoga/Yoga.c#L1961
      ...
      for (i = firstComplexMain; i < endLine; ++i) {
        ...
        if (getPositionType(child) === CSS_POSITION_ABSOLUTE &&
          ...
          if (getPositionType(child) === CSS_POSITION_RELATIVE) {
            ...
            // We only need to do that for relative elements.
            ...
            child.layout[pos[mainAxis]] = getLeadingBorder(node, mainAxis) +
              getLeadingMargin(child, mainAxis);
          }
        }
      }
