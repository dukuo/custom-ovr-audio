 ...
 * loads and decodes audio samples with audioCtx. It can be
...
export default function AudioSampleLoader() {

}

AudioSampleLoader.prototype = Object.assign( Object.create( Object.prototype ), {
  constructor: AudioSampleLoader,
  send: function () {
  ...
  loadOneOfBuffers: function (url, index) {
    "use strict";
    var console = window.console,
      loader = this,
      XHR = new XMLHttpRequest();
